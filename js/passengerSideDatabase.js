function submitOffer() {
  document.getElementById("submitOffer").addEventListener("click", submitClick());
}
...
var elmtTable = document.getElementById('tableRequestsAll');
...
var elmtTable = document.getElementById('tableRequestsPWM');
var tableRows = elmtTable.getElementsByTagName('tr');
var rowCount = tableRows.length;
for (var x = rowCount - 1; x > 0; x--) {
  tableRows[x].innerHTML = '';
...
function submitClick() {
  ...
  if (validate()) {
    ...
    alert("Thank you for your offer! You can see it on the Passenger side");
...
function createCell(dateInput, fromInput, destInput, nameInput, priceInput, seatsInput) {
  ...
  if (dest.innerHTML == "PWM") {
    var tablePWM = document.getElementById("tableRequestsPWM");
    tablePWM.append(newBody);
  } else {
    var tableAll = document.getElementById("tableRequestsAll");
